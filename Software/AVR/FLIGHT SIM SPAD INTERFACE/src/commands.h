...
// switches
_INIT_P_STR_(pstr_antiskid,           "ANTISKID BRAKES ACTIVE");  // for data sub
...
_INIT_P_STR_(pstr_gndSpoilerArm,         "SPOILERS ARMED"); //sub (simconnect)
//_INIT_P_STR_(pstr_gndSpoilerArm,         "SPOILERS_ARM_TOGGLE"); // used for calling in data sub onChangeGNDSpoilerArm() (simconnect)
...
#define ipstr_revThrustToggle    8
#define ipstr_parkBrakeState     9
#define ipstr_apuGenSwitchPos    10
#define ipstr_apuBleedSwitchPos  11
#define ipstr_apuMasterSwitchPos  12
#define ipstr_extPowerSwitchPos   13
#define ipstr_apuStarter          14
#define ipstr_gndSpoilerArm       15


const char* const PSTR_TABLE_CMDs[] PROGMEM = {pstr_antiskid, pstr_fuelValveToggle, pstr_fuel_pump, pstr_parkbrake,
  pstr_abrakeControlLevel, pstr_externalPower, pstr_apuBleed, pstr_apuGen, pstr_revThrustToggle,
  pstr_parkBrakeState,
